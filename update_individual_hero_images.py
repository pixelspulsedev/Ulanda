#!/usr/bin/env python3
"""Update individual condition detail page hero images."""
import re
...
new_urls = {
    ...
    'low-immunity': 'https://www.drtatiana.co.uk/wp-content/uploads/smush-webp/2019/03/low-immunity-548x794.jpg.webp',
...
# Update each condition's hero image
for condition_id, new_url in new_urls.items():
    # Pattern: id: 'condition-id' ... hero: { ... image: "old-url"
    # Find the hero section after the id and replace the image value
...
print(f"✓ Updated {updated_count} individual condition detail page hero images")
