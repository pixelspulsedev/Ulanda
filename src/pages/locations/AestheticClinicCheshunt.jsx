  ...
  '@graph': [
    {
      ...
      areaServed: [
        ...
        { '@type': 'Place', name: 'Goffs Oak' },
        { '@type': 'Place', name: 'Flamstead End' },
...
export default function AestheticClinicCheshunt() {
  return (
    <>
      <Head>
        <title>Skin Clinic Near Cheshunt | ULANDA Ware</title>
        <meta name="description" content="Nurse-led skin clinic near Cheshunt, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 15 min drive." />
        ...
        <meta property="og:title" content="Skin Clinic Near Cheshunt | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic near Cheshunt, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 15 min drive." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-cheshunt" />
      </Head>
      ...
      <div className="bg-base-100 min-h-screen">
        ...
        <section className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-serif text-base-content leading-tight mb-4">
              <HeroText>Skin Clinic Near Cheshunt for Consultation-Led Skin Health</HeroText>
            </h1>
            ...
            <FadeInWhenVisible>
              <div className="space-y-6 text-base-content/80 text-lg leading-relaxed">
                <p>ULANDA is a nurse-led skin clinic near Cheshunt, located in Ware and serving clients across Hertfordshire and North London who are seeking consultation-led skin care and structured skin health programmes.</p>
                <p>Many clients travel from Cheshunt, particularly from neighbourhoods around Goffs Oak, Flamstead End and the Cheshunt Old Pond area when they are looking for a more clinically guided approach to skin concerns including damaged skin barrier, pigmentation, hormonal skin changes and early structural ageing where treatment decisions begin with understanding how the skin is functioning biologically before any procedure is recommended.</p>
                ...
                <p>Clients visiting from Cheshunt often also explore ULANDA's wider <Link to="/locations/aesthetic-clinic-hertfordshire" className="text-primary hover:text-primary/80 underline underline-offset-2 transition-colors">Hertfordshire skin clinic page</Link> for an overview of the conditions, programmes and treatment pathways available across the region.</p>
              </div>
            </FadeInWhenVisible>
            <FadeInWhenVisible delay={0.1}>
              <div className="mt-8 bg-secondary/30 rounded-xl p-6 md:p-8 border border-primary/10">
                <p className="text-base-content/70 text-sm mb-2">ULANDA is approximately 15 minutes from Cheshunt · Free parking on site · £175 fully redeemable</p>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Why Clients from Cheshunt Visit ULANDA</h2>
                <p className="text-xl font-light text-primary mb-6">A Different Starting Point</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed">Many clients travel from Cheshunt to ULANDA when they are seeking a more structured and clinically guided approach to skin health, particularly when previous treatments have produced temporary improvement but have not addressed the underlying drivers of skin change.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">ULANDA's consultation-led model begins with understanding how the skin behaves before deciding how it should be treated. This differs from the approach taken by many aesthetic clinics serving the Cheshunt area, where treatment choice often precedes clinical assessment.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <p className="text-base-content/80 text-lg font-medium mt-6 mb-3">Clients visiting from Cheshunt often value:</p>
                <ul className="space-y-3">
                  {[
                    ...
                    'A calm clinical environment with free on-site parking and a straightforward journey from Cheshunt',
                  ].map((item, idx) => (
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-3">Skin Concerns Commonly Assessed for Clients from Cheshunt</h2>
                <p className="text-xl font-light text-primary mb-6">The Presentations Most Commonly Seen at ULANDA</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Clients travelling from Cheshunt visit ULANDA for support with a range of skin concerns. Each concern links to a page explaining how the condition develops, how it is assessed during consultation, and the treatment approaches used at ULANDA.</p>
              </FadeInWhenVisible>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Treatments Available Near Cheshunt</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-3">The Full Range of Medical Aesthetic Treatments — Around 15 Minutes From Cheshunt</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Many visitors searching for a skin clinic near Cheshunt already know the treatment they are interested in. The treatments below are available at ULANDA in Ware and are introduced following the Advanced Skin Health Consultation to ensure they are clinically appropriate.</p>
              </FadeInWhenVisible>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                ...
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting from Cheshunt begin with the Advanced Skin Health Consultation — the clinical assessment that establishes what your skin actually needs before any treatment is recommended.</p>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-6">Travelling from Cheshunt</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">ULANDA is approximately 15 minutes from Cheshunt via the A10, providing direct access from Cheshunt town centre and surrounding residential areas.</p>
              </FadeInWhenVisible>
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <FadeInWhenVisible delay={0.1}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    ...
                    <p className="text-base-content/80 leading-relaxed">ULANDA has dedicated free client parking directly at the clinic, making visits convenient for clients travelling from Cheshunt and surrounding areas.</p>
                  </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible delay={0.2}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    <h3 className="text-lg font-serif text-base-content mb-3">By Train</h3>
                    <p className="text-base-content/80 leading-relaxed">Cheshunt station connects to Ware via the Hertford East rail line.</p>
                  </div>
                </FadeInWhenVisible>
              </div>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-5">Serving Cheshunt and Surrounding Areas</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting ULANDA from Cheshunt often travel from surrounding areas including Goffs Oak, Flamstead End, Waltham Cross, Broxbourne and North London.</p>
