...
const locationSchema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://www.ulanda.co.uk/locations/aesthetic-clinic-stanstead-abbotts#breadcrumb',
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: "Skin Clinic Near Stanstead Abbotts", item: 'https://www.ulanda.co.uk/locations/aesthetic-clinic-stanstead-abbotts' },
      ],
    },
  ],
};
...
export default function AestheticClinicStansteadAbbotts() {
  return (
    <>
      <Head>
        <title>Skin Clinic Near Stanstead Abbotts | ULANDA Ware</title>
        <meta name="description" content="Nurse-led skin clinic near Stanstead Abbotts, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 20 min drive." />
        <link rel="canonical" href="https://www.ulanda.co.uk/locations/aesthetic-clinic-stanstead-abbotts" />
        <script type="application/ld+json">{JSON.stringify(locationSchema)}</script>
        <meta property="og:title" content="Skin Clinic Near Stanstead Abbotts | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic near Stanstead Abbotts, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 20 min drive." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-stanstead-abbotts" />
      </Head>
      ...
      <div className="bg-base-100 min-h-screen">
        ...
        <section className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-serif text-base-content leading-tight mb-4">
              <HeroText>Skin Clinic Near Stanstead Abbotts for Consultation-Led Skin Health</HeroText>
            </h1>
            ...
            <FadeInWhenVisible>
              <div className="space-y-6 text-base-content/80 text-lg leading-relaxed whitespace-pre-line">
                {"Skin Clinic Near Stanstead Abbotts for Consultation-Led Skin Health\nSkin Understood. Then Transformed.\nULANDA is a nurse-led Skin Clinic & Women's Health Practice located in Ware, Hertfordshire, serving clients from Stanstead Abbotts, Stanstead St Margarets, Much Hadham and surrounding East Hertfordshire communities.\nMany clients choose ULANDA when they are looking for consultation-led skin health, regenerative aesthetics and personalised treatment planning that begins with understanding how the skin is behaving before treatment is recommended.\nRather than selecting treatments in isolation, ULANDA begins with an Advanced Skin Health Consultation, where skin biology, barrier behaviour, hormonal context and treatment readiness are assessed before any treatment pathway is confirmed.\nFree parking on site · Consultation £175 fully redeemable"}
              </div>
            </FadeInWhenVisible>
            <FadeInWhenVisible delay={0.1}>
              <div className="mt-8 bg-secondary/30 rounded-xl p-6 md:p-8 border border-primary/10">
                <p className="text-base-content/70 text-sm mb-2">ULANDA is approximately 20 minutes from Stanstead Abbotts · Free parking on site</p>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Why Clients from Stanstead Abbotts Visit ULANDA</h2>
                <p className="text-xl font-light text-primary mb-6">A Different Starting Point</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed">Many clients travel from Stanstead Abbotts to ULANDA when they are seeking a more structured and clinically guided approach to skin health, particularly when previous treatments have delivered temporary improvement but not lasting change.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">ULANDA's consultation-led model begins with understanding how the skin behaves before deciding how it should be treated. This differs from many aesthetic clinics serving the Stanstead Abbotts area, where treatment selection often precedes clinical assessment.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <p className="text-base-content/80 text-lg font-medium mt-6 mb-3">Clients visiting from Stanstead Abbotts often value:</p>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-3">Skin Concerns Commonly Assessed for Clients from Stanstead Abbotts</h2>
                <p className="text-xl font-light text-primary mb-6">The Presentations Most Commonly Seen at ULANDA</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Clients travelling from Stanstead Abbotts visit ULANDA for support with a range of skin concerns. Each links to the relevant authority page within the ULANDA ecosystem for the full clinical picture.</p>
              </FadeInWhenVisible>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Treatments Available Near Stanstead Abbotts</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-3">The Full Range of Medical Aesthetic Treatments — Around 20 Minutes From Stanstead Abbotts</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Many visitors searching for a skin clinic near Stanstead Abbotts already know the treatment they are interested in. The treatments below are available at ULANDA in Ware and are introduced following the Advanced Skin Health Consultation to ensure they are clinically appropriate.</p>
              </FadeInWhenVisible>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                ...
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting from Stanstead Abbotts begin with the Advanced Skin Health Consultation — the clinical assessment that establishes what your skin actually needs before any treatment is recommended.</p>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-6">Travelling from Stanstead Abbotts</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">ULANDA is approximately 20 minutes from Stanstead Abbotts via the A1184, a straightforward route connecting the town centre to Ware.</p>
              </FadeInWhenVisible>
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <FadeInWhenVisible delay={0.2}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    ...
                    <p className="text-base-content/80 leading-relaxed">Stanstead Abbotts station connects to Ware via the Hertford East rail line, with a short change at Broxbourne.</p>
                  </div>
                </FadeInWhenVisible>
              </div>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-5">Serving Stanstead Abbotts and East Hertfordshire</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting ULANDA from Stanstead Abbotts often travel from surrounding areas including Thorley, St Michael's Mead, Stansted Mountfitchet and Sawbridgeworth.</p>
