  ...
  '@graph': [
    {
      ...
      areaServed: [
        ...
        { '@type': 'Place', name: 'Bengeo' },
        { '@type': 'Place', name: 'Hertford Heath' },
        { '@type': 'Place', name: 'Hertingfordbury' },
        { '@type': 'Place', name: 'Sele Farm' },
        { '@type': 'City', name: 'Ware' },
...
const concerns = [
  ...
  },
  {
    ...
    description:
      'Hormonal fluctuations across adult life, postpartum recovery, the shifts of the late 30s and hormonal transition directly influence skin hydration, barrier function, collagen synthesis and inflammatory response. Consultation establishes the hormonal context as clinical data that shapes every treatment recommendation.',
  ...
  },
  {
    ...
    description:
      'Chronic redness and reactive skin are almost always driven by a combination of barrier compromise, vascular instability and inflammatory dysregulation. The assessment establishes what is driving the pattern before any treatment is introduced.',
  ...
  },
  {
    ...
    description:
      'Reduced elasticity, early laxity and the loss of skin resilience that accompanies collagen decline require a different clinical approach from surface correction. Consultation determines the regenerative programme most appropriate for supporting skin architecture over time.',
    link: '/conditions',
...
const signatureProgrammes = [
  ...
  },
  {
    ...
    description:
      'For chronic inflammatory redness, vascular reactivity and rosacea-spectrum presentations.',
  },
  {
    name: 'Menopause Skin Rebuild',
    path: '/signature/menopause-skin-rebuild',
    description:
      'For skin navigating barrier thinning, collagen decline and the changes of hormonal transition.',
  },
  {
    name: 'Photoaging & Skin Architecture',
    path: '/signature/photoaging-skin-architecture',
    description:
      'For cumulative UV damage, pigmentation irregularity and early architectural change.',
  },
  {
    name: 'Structural Skin Regeneration',
    path: '/signature/structural-skin-regeneration',
    description:
      'For skin requiring regenerative injectable and biostimulation support.',
  },
  {
    name: 'Under-Eye Renewal',
    path: '/signature/under-eye-renewal',
    description:
      'For hollowing, dark discolouration, fine crepiness and periorbital tissue quality decline.',
  },
];
...
const faqs = [
  {
    q: 'Is ULANDA near Hertford?',
    a: 'Yes. ULANDA is located in Ware, approximately 3.5 miles from Hertford town centre, around a 10-minute drive.',
  },
  {
    q: 'Is there parking?',
  ...
  },
  {
    ...
    a: 'Yes. All new clients begin with the Advanced Skin Health Consultation.',
  },
  {
    q: 'Does ULANDA offer Botox and dermal fillers near Hertford?',
...
export default function AestheticClinicHertford() {
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Skin Clinic Near Hertford | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic near Hertford, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 10 min drive." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-hertford" />
      </Head>
      ...
      <div className="bg-base-100 min-h-screen">
        ...
        <section className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-serif text-base-content leading-tight mb-4">
              <HeroText>Skin Clinic Near Hertford for Consultation-Led Skin Health</HeroText>
            </h1>
            ...
            <FadeInWhenVisible>
              <div className="space-y-6 text-base-content/80 text-lg leading-relaxed">
                <p>ULANDA is a nurse-led skin clinic near Hertford, located in Ware and serving clients across East Hertfordshire who are seeking consultation-led skin care and structured skin health programmes.</p>
                <p>Many clients travel from Hertford, particularly from areas around Bengeo, Hertford Heath and Hertingfordbury to ULANDA when they are looking for a more comprehensive approach to skin concerns such as damaged skin barrier, pigmentation, hormonal skin changes and early structural ageing where the starting point is understanding what the skin is doing biologically before any treatment is recommended.</p>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Why Clients from Hertford Visit ULANDA</h2>
                <p className="text-xl font-light text-primary mb-6">A Different Starting Point</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed">Many clients travel from Hertford to ULANDA when they are seeking a more structured and clinically guided approach to skin health, often when previous treatments have helped temporarily but not lastingly.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">ULANDA's consultation-led model begins with understanding how the skin behaves before deciding how it should be treated. This approach differs from many aesthetic clinics where the focus begins with selecting a treatment.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <p className="text-base-content/80 text-lg font-medium mt-6 mb-3">Clients visiting from Hertford often value:</p>
                <ul className="space-y-3">
                  {[
                    ...
                    'Regenerative treatments that support collagen and long-term skin function',
                    'A calm clinical environment with free on-site parking and a 10-minute journey from Hertford',
                  ].map((item, idx) => (
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Skin Concerns Commonly Seen in Clients Visiting from Hertford</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Clients travelling from Hertford visit ULANDA for support with a range of skin concerns. Each links to the relevant authority page within the ULANDA ecosystem for the full clinical picture.</p>
              </FadeInWhenVisible>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Treatments Available Near Hertford</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-3">The Full Range of Medical Aesthetic Treatments — 10 Minutes From Hertford</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Many visitors searching for a skin clinic near Hertford already know the treatment they are interested in. The treatments below are available at ULANDA in Ware and are introduced following the Advanced Skin Health Consultation to ensure they are appropriate and correctly sequenced within your treatment programme.</p>
              </FadeInWhenVisible>
              ...
              <p className="text-base-content/80 text-lg leading-relaxed">All treatments are introduced following the Advanced Skin Health Consultation to ensure the approach chosen is appropriate for your skin and sequenced correctly within your treatment plan.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting from Hertford begin with the Advanced Skin Health Consultation — the clinical assessment that establishes what your skin actually needs before any treatment is recommended.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">During the consultation the clinical team assesses:</p>
                <ul className="space-y-3">
                  {[
                    'Skin barrier behaviour and integrity',
                    'Inflammatory patterns and inflammatory load',
                    'Skin history and previous treatment response',
                    'Hormonal context',
                    'Hydration balance and cellular turnover',
                    'Treatment readiness',
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-base-content/80 text-lg leading-relaxed"><span className="w-2 h-2 rounded-full bg-primary mt-2.5" />{item}</li>
                  ))}
                </ul>
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">The consultation includes AI Skin Analysis, barrier evaluation and the Skin Barrier Renewal Protocol delivered within the same appointment.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-6">Travelling from Hertford</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">ULANDA is approximately 10 minutes from Hertford town centre via the A119, a short journey from areas such as Bengeo, Hertford Heath and the SG13 and SG14 residential neighbourhoods.</p>
              </FadeInWhenVisible>
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <FadeInWhenVisible delay={0.1}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    ...
                    <p className="text-base-content/80 leading-relaxed">ULANDA has dedicated free client parking directly at the clinic, meaning clients travelling from Hertford do not need to use town-centre car parks or manage parking charges.</p>
                  </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible delay={0.2}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    <h3 className="text-lg font-serif text-base-content mb-3">By Train</h3>
                    <p className="text-base-content/80 leading-relaxed">Hertford North and Hertford East both connect to Ware via the Hertford East line. Ware station is approximately a 10-minute walk from the clinic.</p>
                  </div>
                </FadeInWhenVisible>
              </div>
              ...
              <FadeInWhenVisible delay={0.4}>
                <p className="text-base-content/80 text-lg leading-relaxed mt-6">ULANDA also welcomes clients from Hoddesdon, Broxbourne, Bishop's Stortford, Stanstead Abbotts and across East Hertfordshire.</p>
              </FadeInWhenVisible>
            </div>
          </div>
        </section>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-5">Serving Hertford and East Hertfordshire</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting ULANDA from Hertford often travel from surrounding areas including Bengeo, Hertford Heath, Hertingfordbury, Sele Farm and the SG13 and SG14 neighbourhoods.</p>
