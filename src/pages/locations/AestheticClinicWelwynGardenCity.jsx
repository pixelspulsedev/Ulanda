  ...
  "@graph": [
    {
      ...
      "areaServed": [
        ...
        { "@type": "Place", "name": "Handside" },
        { "@type": "Place", "name": "Panshanger" },
...
const clientValues = [
  ...
  'A calm clinical environment with free on-site parking and a straightforward journey from Welwyn Garden City',
];
...
export default function AestheticClinicWelwynGardenCity() {
  return (
    <>
      <Head>
        <title>Skin Clinic Near Welwyn Garden City | ULANDA Ware</title>
        <meta name="description" content="Nurse-led skin clinic near Welwyn Garden City, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 25 min drive." />
        ...
        <meta property="og:title" content="Skin Clinic Near Welwyn Garden City | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic near Welwyn Garden City, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 25 min drive." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-welwyn-garden-city" />
      </Head>
      ...
      <div className="bg-base-100 min-h-screen">
        ...
        <section className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-serif text-base-content leading-tight mb-4">
              <HeroText>Skin Clinic Near Welwyn Garden City for Consultation-Led Skin Health</HeroText>
            </h1>
            ...
            <FadeInWhenVisible delay={0.2}>
              <div className="space-y-6 text-base-content/80 text-lg leading-relaxed">
                <p>
                  ULANDA is a nurse-led skin clinic near Welwyn Garden City, located in Ware and serving clients across Hertfordshire who are seeking consultation-led skin care and structured skin health programmes.
                </p>
                <p>
                  Many clients travel from Welwyn Garden City &mdash; particularly from neighbourhoods around Handside, Panshanger and the town centre &mdash; when they are looking for a more clinically guided approach to skin concerns &mdash; including damaged skin barrier, pigmentation, hormonal skin changes and early structural ageing &mdash; where treatment decisions begin with understanding the biological behaviour of the skin before any procedure is recommended.
                </p>
                <p>
            ...
            <FadeInWhenVisible delay={0.4}>
              <div className="mt-8 bg-secondary/30 rounded-xl p-6 md:p-8 border border-primary/10">
                <p className="text-base-content/70 text-sm mb-2">ULANDA is approximately 25 minutes from Welwyn Garden City &middot; Free parking on site</p>
        ...
        {/* Section: Why Clients from Welwyn Garden City Visit ULANDA */}
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl md:text-3xl font-serif text-base-content mb-4">Why Clients from Welwyn Garden City Visit ULANDA</h2>
              ...
              <FadeInWhenVisible delay={0.1}>
                <div className="space-y-6 text-base-content/80 text-lg leading-relaxed mb-8">
                  <p>
                    Many clients travel from Welwyn Garden City to ULANDA when they are seeking a more structured and clinically guided approach to skin health &mdash; particularly when previous treatments have delivered temporary improvement but not lasting change.
                  </p>
                  <p>
                    ULANDA&rsquo;s consultation-led model begins with understanding how the skin behaves before deciding how it should be treated. This differs from many aesthetic clinics serving the Welwyn Garden City area where treatment selection often precedes clinical assessment.
                  </p>
                </div>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <p className="text-base-content/80 text-lg font-medium mb-4">Clients visiting from Welwyn Garden City often value:</p>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl md:text-3xl font-serif text-base-content mb-4">Skin Concerns Commonly Assessed for Clients from Welwyn Garden City</h2>
                ...
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">
                  Clients travelling from Welwyn Garden City visit ULANDA for support with a range of skin concerns. Each concern links to a page explaining how the condition develops, how it is assessed during consultation, and the treatment approaches used at ULANDA.
                </p>
              </FadeInWhenVisible>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl md:text-3xl font-serif text-base-content mb-4">Treatments Available Near Welwyn Garden City</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">
                  The full range of medical aesthetic treatments &mdash; around 25 minutes from Welwyn Garden City. Many visitors searching for a skin clinic near Welwyn Garden City already know the treatment they are interested in. The treatments below are available at ULANDA in Ware and are introduced following the Advanced Skin Health Consultation to ensure they are clinically appropriate.
                </p>
              </FadeInWhenVisible>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">
                  Clients visiting from Welwyn Garden City begin with the Advanced Skin Health Consultation &mdash; the clinical assessment that establishes what your skin actually needs before any treatment is recommended.
                </p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <div className="mb-8">
        ...
        {/* Section: Travelling from Welwyn Garden City */}
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl md:text-3xl font-serif text-base-content mb-6">Travelling from Welwyn Garden City</h2>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">
                  ULANDA is approximately 25 minutes from Welwyn Garden City via the A414, connecting the town directly to Ware.
                </p>
              </FadeInWhenVisible>
                ...
                <FadeInWhenVisible delay={0.2}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    ...
                    <p className="text-base-content/80 leading-relaxed">
                      ULANDA has dedicated free client parking directly at the clinic, making visits convenient for clients travelling from Welwyn Garden City.
                    </p>
                  </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible delay={0.3}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    ...
                    <p className="text-base-content/80 leading-relaxed">
                      Welwyn Garden City station connects to Ware via the Hertford East rail line, typically with a change at Hertford East.
                    </p>
                  </div>
                </FadeInWhenVisible>
              </div>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-lg font-serif text-base-content mb-4">Serving Welwyn Garden City and Surrounding Areas</h2>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <div className="text-base-content/80 text-lg leading-relaxed mb-4">
                  <p className="mb-4">Clients visiting ULANDA from Welwyn Garden City often travel from surrounding areas including Handside, Panshanger, Hatfield and Hertford.</p>
                  <div>
