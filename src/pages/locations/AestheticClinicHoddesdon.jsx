  ...
  '@graph': [
    {
      ...
      areaServed: [
        ...
        { '@type': 'Place', name: 'Rye Park' },
        { '@type': 'Place', name: 'Barclay Park' },
...
const signatureProgrammes = [
  {
    ...
    description: 'For skin requiring foundational barrier restoration before more active treatments can be safely introduced.',
  },
  {
    name: 'Rosacea & Redness Control',
    path: '/signature/rosacea-redness-control',
    description: 'For chronic inflammatory redness, vascular reactivity and rosacea-spectrum presentations.',
  },
  {
    name: 'Menopause Skin Rebuild',
    path: '/signature/menopause-skin-rebuild',
    description: 'For skin navigating barrier thinning, collagen decline and the changes of hormonal transition.',
  },
  {
    name: 'Photoaging & Skin Architecture',
    path: '/signature/photoaging-skin-architecture',
    description: 'For cumulative UV damage, pigmentation irregularity and early architectural change.',
  },
  {
    name: 'Structural Skin Regeneration',
    path: '/signature/structural-skin-regeneration',
    description: 'For skin requiring regenerative injectable and biostimulation support.',
  },
  {
    name: 'Under-Eye Renewal',
    path: '/signature/under-eye-renewal',
    description: 'For hollowing, dark discolouration, fine crepiness and periorbital tissue quality decline.',
  },
];
...
const faqs = [
  {
    q: 'Is ULANDA near Hoddesdon?',
    a: 'Yes. ULANDA is located in Ware, approximately 4 miles from Hoddesdon, around an 8 to 10 minute drive.',
  },
  {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Skin Clinic Near Hoddesdon | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic near Hoddesdon, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 10 min drive." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-hoddesdon" />
      </Head>
      ...
      <div className="bg-base-100 min-h-screen">
        ...
        <section className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-serif text-base-content leading-tight mb-4">
              <HeroText>Skin Clinic Near Hoddesdon for Consultation-Led Skin Health</HeroText>
            </h1>
            ...
            <FadeInWhenVisible>
              <div className="space-y-6 text-base-content/80 text-lg leading-relaxed">
                <p>ULANDA is a nurse-led skin clinic near Hoddesdon, located in Ware and serving clients across East Hertfordshire who are seeking consultation-led skin care and structured skin health programmes.</p>
                <p>Many clients travel from Hoddesdon, particularly from areas around Rye Park, Barclay Park and the High Street neighbourhoods, when they are looking for a more comprehensive approach to skin concerns including damaged skin barrier, pigmentation, hormonal skin changes and early structural ageing where the starting point is a clinical understanding of what the skin is doing and why before any treatment is recommended.</p>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Why Clients from Hoddesdon Visit ULANDA</h2>
                <p className="text-xl font-light text-primary mb-6">A Different Starting Point</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed">Many clients travel from Hoddesdon to ULANDA when they are seeking a more structured and clinically guided approach to skin health, often after experiencing treatments that delivered short-term improvement but did not address the biological drivers behind their skin concerns.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">ULANDA's consultation-led model begins with understanding how the skin behaves before deciding how it should be treated. This differs from the approach used by many aesthetic clinics serving the Hoddesdon area, where treatment choice often precedes clinical assessment.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <p className="text-base-content/80 text-lg font-medium mt-6 mb-3">Clients visiting from Hoddesdon typically value:</p>
                <ul className="space-y-3">
                  {[
                    ...
                    'A calm clinical environment with free on-site parking and a short journey from Hoddesdon',
                  ].map((item, idx) => (
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-3">Skin Concerns Commonly Assessed for Clients from Hoddesdon</h2>
                <p className="text-xl font-light text-primary mb-6">The Presentations Most Commonly Seen at ULANDA</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Clients travelling from Hoddesdon visit ULANDA for support with a range of skin concerns. Each links to the relevant authority page within the ULANDA ecosystem for the full clinical picture.</p>
              </FadeInWhenVisible>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Treatments Available Near Hoddesdon</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-3">The full range of medical aesthetic treatments around 8 to 10 minutes from Hoddesdon.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">All treatments at ULANDA are introduced following the Advanced Skin Health Consultation to ensure they are clinically appropriate and correctly sequenced within your treatment programme.</p>
              </FadeInWhenVisible>
              ...
              <p className="text-base-content/80 text-lg leading-relaxed">All treatments are introduced following the Advanced Skin Health Consultation to ensure they are appropriate and sequenced correctly within your treatment programme.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting from Hoddesdon begin with the Advanced Skin Health Consultation, the clinical assessment that establishes what your skin actually needs before any treatment is recommended.</p>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-6">Travelling from Hoddesdon</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">ULANDA is approximately 10 minutes from Hoddesdon via the A1170 and A10, with convenient access from Rye Park and surrounding residential areas.</p>
              </FadeInWhenVisible>
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <FadeInWhenVisible delay={0.1}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    ...
                    <p className="text-base-content/80 leading-relaxed">ULANDA has dedicated free client parking directly at the clinic, meaning clients travelling from Hoddesdon do not need to use town-centre car parks or manage parking charges.</p>
                  </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible delay={0.2}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    <h3 className="text-lg font-serif text-base-content mb-3">By Train</h3>
                    <p className="text-base-content/80 leading-relaxed">Hoddesdon connects to Ware via the Hertford East rail line. Ware station is approximately a 10-minute walk from the clinic.</p>
                  </div>
                </FadeInWhenVisible>
              </div>
              ...
              <FadeInWhenVisible delay={0.4}>
                <p className="text-base-content/80 text-lg leading-relaxed mt-6">ULANDA also welcomes clients from Broxbourne, Hertford, Bishop's Stortford, Stanstead Abbotts and across East Hertfordshire.</p>
              </FadeInWhenVisible>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <FadeInWhenVisible>
                ...
                <p className="text-base-content/80 text-lg leading-relaxed">Join women across Hertfordshire receiving clinical insights from lead clinician Helen Balogun. No product promotions. No sales emails. Just clinical intelligence, when it is useful.</p>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-5">Serving Hoddesdon and East Hertfordshire</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting ULANDA from Hoddesdon often travel from surrounding areas including Rye Park, Broxbourne, Wormley and Stanstead Abbotts.</p>
