...
const faqs = [
  {
    q: 'Is ULANDA near Broxbourne?',
    a: 'Yes. ULANDA is in Ware, approximately 5 miles from Broxbourne town centre, typically around a 10 to 12 minute drive.',
  },
  {
    q: 'Is there parking at ULANDA?',
    a: 'Yes. ULANDA has free dedicated client parking on site.',
  },
  {
    q: 'Do I need a consultation before any treatment?',
    a: 'Yes. The Advanced Skin Health Consultation is the required starting point for all new clients. The £175 fee is fully redeemable against your treatment plan when you proceed.',
  },
  {
    q: 'Does ULANDA offer Botox and dermal fillers near Broxbourne?',
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Skin Clinic Near Broxbourne | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic near Broxbourne, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 10–12 min drive." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-broxbourne" />
      </Head>
      ...
      <div className="bg-base-100 min-h-screen">
        ...
        <section className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-serif text-base-content leading-tight mb-4">
              <HeroText>Skin Clinic Near Broxbourne for Consultation-Led Skin Health</HeroText>
            </h1>
            ...
            <FadeInWhenVisible>
              <div className="space-y-6 text-base-content/80 text-lg leading-relaxed">
                <p>ULANDA is a nurse-led skin clinic near Broxbourne, located in Ware and serving clients across East Hertfordshire who are seeking consultation-led skin care and structured skin health programmes.</p>
                <p>Many clients travel from Broxbourne, particularly from neighbourhoods around Broxbourne Station, Wormley and the New River corridor when they are looking for a more comprehensive approach to skin concerns from damaged skin barrier, pigmentation, hormonal skin changes and early structural ageing and seek a medical aesthetic clinic where the starting point is a clinical understanding of what the skin is doing and why, before any treatment is recommended.</p>
                <p>Rather than selecting treatments in isolation, ULANDA begins with an Advanced Skin Health Consultation where skin biology, barrier behaviour, hormonal context and treatment readiness are assessed before any treatment pathway is confirmed. You leave your first appointment with visible improvement in your skin and a complete written programme recommendation.</p>
                <p>Clients visiting from Broxbourne often also explore ULANDA's wider <Link to="/locations/aesthetic-clinic-hertfordshire" className="text-primary hover:text-primary/80 underline underline-offset-2 transition-colors">Hertfordshire skin clinic page</Link> for an overview of the conditions, programmes and treatment pathways available across the region.</p>
              </div>
            </FadeInWhenVisible>
            <FadeInWhenVisible delay={0.1}>
              <div className="mt-8 bg-secondary/30 rounded-xl p-6 md:p-8 border border-primary/10">
                <p className="text-base-content/70 text-sm mb-2">ULANDA is located 10 to 12 minutes drive from Broxbourne · Free parking on site</p>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Why Clients from Broxbourne Visit ULANDA</h2>
                <p className="text-xl font-light text-primary mb-6">A Different Starting Point</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed">Many clients travel from Broxbourne to ULANDA when they are seeking a more structured and clinically guided approach to skin health, when previous treatments have helped temporarily but not lastingly, or when skincare routines have stopped producing the results they once did.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">ULANDA's consultation-led model begins with understanding how the skin behaves before deciding how it should be treated. This is not standard practice at most aesthetic clinics serving the Broxbourne area. At ULANDA it is the foundation of every client programme.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <p className="text-base-content/80 text-lg font-medium mt-6 mb-3">Clients visiting from Broxbourne typically value:</p>
                <ul className="space-y-3">
                  {[
                    'Consultation-led skin assessment before any treatment is selected',
                    ...
                    'Regenerative treatments that support collagen and long-term skin function rather than temporary surface correction',
                    'A calm clinical environment with free on-site parking and a short journey from Broxbourne',
                  ].map((item, idx) => (
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-3">Skin Concerns Commonly Assessed for Clients from Broxbourne</h2>
                <p className="text-xl font-light text-primary mb-6">The Presentations Most Commonly Seen at ULANDA</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Clients travelling from Broxbourne visit ULANDA for support with a range of skin concerns. Each links to the relevant authority page within the ULANDA ecosystem for the full clinical picture.</p>
              </FadeInWhenVisible>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Treatments Available Near Broxbourne</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-3">The Full Range of Medical Aesthetic Treatments — Around 10 to 12 Minutes From Broxbourne</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">All treatments at ULANDA are introduced following the Advanced Skin Health Consultation, ensuring what you receive is clinically appropriate, correctly sequenced and designed to produce results that last.</p>
              </FadeInWhenVisible>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                ...
                <p className="text-xl font-light text-primary mb-6">Begin With Understanding</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting from Broxbourne begin with the Advanced Skin Health Consultation — the clinical assessment that establishes what your skin actually needs before any treatment is recommended.</p>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Hormonal context and its influence on presenting concerns',
                ...
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">The consultation includes AI Skin Analysis, barrier evaluation, hormonal history review and the Skin Barrier Renewal Protocol — your first clinical treatment — delivered within the same appointment.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-6">Travelling from Broxbourne</h2>
                <p className="text-xl font-light text-primary mb-4">Getting Here</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">ULANDA is located in Ware, East Hertfordshire — approximately 5 miles from Broxbourne town centre, typically around 10 to 12 minutes by car depending on traffic conditions.</p>
              </FadeInWhenVisible>
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <FadeInWhenVisible delay={0.1}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    ...
                    <p className="text-base-content/80 leading-relaxed">ULANDA has dedicated free client parking at the clinic, with no need to use town centre car parks or manage parking charges.</p>
                  </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible delay={0.2}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    <h3 className="text-lg font-serif text-base-content mb-3">By Train</h3>
                    <p className="text-base-content/80 leading-relaxed">Broxbourne station provides direct rail access toward Ware via the Hertford East line. Ware station is approximately a 10-minute walk from the clinic.</p>
                  </div>
                </FadeInWhenVisible>
              </div>
              ...
              <FadeInWhenVisible delay={0.4}>
                <p className="text-base-content/80 text-lg leading-relaxed mt-6">ULANDA also welcomes clients from Hoddesdon, Hertford, Bishop's Stortford, Stanstead Abbotts and the wider East Hertfordshire SG12 corridor.</p>
              </FadeInWhenVisible>
            </div>
          </div>
        </section>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-5">Serving Broxbourne and East Hertfordshire</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting ULANDA from Broxbourne often travel from surrounding areas including Wormley, Turnford, Hoddesdon, Hertford, Ware, Stanstead Abbotts, Bishop's Stortford, Sawbridgeworth and the wider EN10 and EN11 areas.</p>
