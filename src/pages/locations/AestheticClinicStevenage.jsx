...
export default function AestheticClinicStevenage() {
  return (
    <>
      <Head>
        <title>Skin Clinic Near Stevenage | ULANDA Ware</title>
        <meta name="description" content="Nurse-led skin clinic near Stevenage, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 30 min drive." />
        ...
        <meta property="og:title" content="Skin Clinic Near Stevenage | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic near Stevenage, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 30 min drive." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-stevenage" />
      </Head>
