...
export default function AestheticClinicBishopsStortford() {
  return (
    <>
      <Head>
        <title>Skin Clinic Near Bishop's Stortford | ULANDA Ware</title>
        <meta name="description" content="Nurse-led skin clinic near Bishop's Stortford, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 20 min drive." />
        ...
        <meta property="og:title" content="Skin Clinic Near Bishop's Stortford | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic near Bishop's Stortford, based in Ware. Barrier assessment, regenerative treatments and structured skin programmes. About 20 min drive." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-bishops-stortford" />
      </Head>
