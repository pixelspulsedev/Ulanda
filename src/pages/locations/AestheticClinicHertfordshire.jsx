...
const breadcrumbSchema = {
  '@context': 'https://schema.org',
  '@type': 'BreadcrumbList',
  '@id': 'https://www.ulanda.co.uk/locations/aesthetic-clinic-hertfordshire#breadcrumb',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.ulanda.co.uk/' },
    { '@type': 'ListItem', position: 2, name: 'Locations', item: 'https://www.ulanda.co.uk/locations/aesthetic-clinic-hertfordshire' },
    { '@type': 'ListItem', position: 3, name: 'Skin Clinic Hertfordshire', item: 'https://www.ulanda.co.uk/locations/aesthetic-clinic-hertfordshire' },
  ],
};
...
const treatmentCategories = [
  ...
  },
  {
    ...
    treatments: [
      ...
      { name: 'PRP', aka: 'Vampire facial · PRP skin rejuvenation · PRP hair loss · blood facial', from: '£POA', link: '/treatments/injectable-skin-optimisation/prp-skin-regeneration' },
  ...
  },
  {
    ...
    treatments: [
      ...
      { name: 'LED therapy', aka: 'LED facial · photobiomodulation · red light therapy · rosacea light treatment', from: '£POA', link: '/treatments/skin-barrier-renewal-protocol' },
    ],
  },
];
...
const faqs = [
  {
    q: 'Is ULANDA a skin clinic in Hertfordshire?',
    a: 'Yes. ULANDA is located in Ware and serves clients across Hertfordshire.',
  },
  {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Skin Clinic Hertfordshire | ULANDA Ware" />
        <meta property="og:description" content="Nurse-led skin clinic in Ware, Hertfordshire. Consultation-led barrier assessment, regenerative treatments and structured skin programmes. Free parking on site." />
        <meta property="og:url" content="https://www.ulanda.co.uk/locations/aesthetic-clinic-hertfordshire" />
      </Head>
      ...
      <div className="bg-base-100 min-h-screen">
        ...
        <section className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-serif text-base-content leading-tight mb-4">
              <HeroText>Skin Clinic in Hertfordshire for Consultation-Led Skin Health</HeroText>
            </h1>
            ...
            <FadeInWhenVisible>
              <div className="space-y-6 text-base-content/80 text-lg leading-relaxed">
                <p>ULANDA is a nurse-led skin clinic in Hertfordshire, located in Ware and serving clients across the county who are seeking consultation-led skin care and structured skin health programmes.</p>
                <p>Clients travel to ULANDA from towns across Hertfordshire when they are looking for a more clinically guided approach to skin concerns including damaged skin barrier, pigmentation, hormonal skin changes and early structural ageing where treatment decisions begin with understanding how the skin is behaving biologically before any procedure is recommended.</p>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto space-y-6">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content">Why Clients Across Hertfordshire Visit ULANDA</h2>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed">Many clients across Hertfordshire seek a more structured and clinically guided approach to skin care when previous treatments have delivered temporary improvement but not lasting change.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">ULANDA's consultation-led model begins with understanding how the skin behaves before deciding how it should be treated.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <p className="text-base-content/80 text-lg">Clients often travel to ULANDA from towns across Hertfordshire including:</p>
                <p className="text-base-content/80 text-lg mt-3">Hertford · Broxbourne · Hoddesdon · Bishop's Stortford · Harlow · Cheshunt · Sawbridgeworth · Welwyn Garden City · Stevenage</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.3}>
                <ul className="space-y-3">
                  {[
                    ...
                    'Regenerative treatments supporting collagen and long-term skin function',
                    'A calm clinical environment with free parking on site',
                  ].map((item, idx) => (
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Skin Concerns Assessed at ULANDA</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Clients across Hertfordshire visit ULANDA for support with a range of skin concerns. Each links to the relevant authority page within the ULANDA ecosystem for the full clinical picture.</p>
              </FadeInWhenVisible>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                ...
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Following consultation, treatment pathways are built around one of ULANDA's Signature programmes.</p>
              </FadeInWhenVisible>
              <div className="grid md:grid-cols-2 gap-5">
                {signatureProgrammes.map((programme, idx) => (
                  <FadeInWhenVisible key={idx} delay={idx * 0.08}>
                    <Link to={programme.path} className="block bg-base-100 rounded-xl p-6 border border-primary/10 hover:border-primary/30 transition-all">
                      <h3 className="font-serif text-lg text-base-content">{programme.name}</h3>
                    </Link>
                  </FadeInWhenVisible>
                ))}
              </div>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Medical Aesthetic Treatments</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">ULANDA provides a full range of treatments introduced following consultation.</p>
              </FadeInWhenVisible>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto space-y-6">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content">The Advanced Skin Health Consultation</h2>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed">Clients visiting from across Hertfordshire begin with the Advanced Skin Health Consultation, the clinical assessment that establishes what your skin actually needs before treatment is recommended.</p>
              ...
              <div className="space-y-4">
                {faqs.map((faq, i) => (
                  <FadeInWhenVisible key={i} delay={i * 0.06}>
                    <div className="bg-base-100 rounded-xl p-6 border border-primary/10">
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-5">Serving Hertfordshire</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">ULANDA serves clients from across Hertfordshire including:</p>
                ...
                <div className="mt-6 bg-secondary/30 rounded-xl p-6 border border-primary/10">
