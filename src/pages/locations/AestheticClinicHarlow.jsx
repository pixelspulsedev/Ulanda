  ...
  '@graph': [
    {
      ...
      areaServed: [
        ...
        { '@type': 'Place', name: 'Old Harlow' },
        { '@type': 'Place', name: 'Church Langley' },
        { '@type': 'Place', name: 'Newhall' },
        ...
        { '@type': 'AdministrativeArea', name: 'West Essex' },
      ],
...
const faqs = [
  {
    q: 'Is ULANDA near Harlow?',
    a: 'Yes. ULANDA is located in Ware, approximately 15 minutes from Harlow by car.',
  },
  {
    q: 'Is there parking?',
  ...
  {
    q: 'Does ULANDA offer Botox and dermal fillers near Harlow?',
      ...
      <div className="bg-base-100 min-h-screen">
        ...
        <section className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-serif text-base-content leading-tight mb-4">
              <HeroText>Skin Clinic Near Harlow for Consultation-Led Skin Health</HeroText>
            </h1>
            ...
            <FadeInWhenVisible>
              <div className="space-y-6 text-base-content/80 text-lg leading-relaxed">
                <p>ULANDA is a nurse-led skin clinic near Harlow, located in Ware and serving clients across East Hertfordshire and Essex who are seeking consultation-led skin care and structured skin health programmes.</p>
                <p>Many clients travel from Harlow, particularly from areas around Old Harlow, Church Langley and Newhall when they are looking for a more clinically guided approach to skin concerns including damaged skin barrier, pigmentation, hormonal skin changes and early structural ageing where treatment decisions are based on understanding the biology of the skin before any procedure is recommended.</p>
                ...
                <p>Clients visiting from Harlow often also explore ULANDA's wider <Link to="/locations/aesthetic-clinic-hertfordshire" className="text-primary hover:text-primary/80 underline underline-offset-2 transition-colors">Hertfordshire skin clinic page</Link> for an overview of the conditions, programmes and treatment pathways available across the region.</p>
              </div>
            </FadeInWhenVisible>
            <FadeInWhenVisible delay={0.1}>
              <div className="mt-8 bg-secondary/30 rounded-xl p-6 md:p-8 border border-primary/10">
                <p className="text-base-content/70 text-sm mb-2">ULANDA is approximately 15 minutes from Harlow · Free parking on site</p>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Why Clients from Harlow Visit ULANDA</h2>
                <p className="text-xl font-light text-primary mb-6">A Different Starting Point</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed">Many clients travel from Harlow to ULANDA when they are seeking a more structured and clinically guided approach to skin health, particularly when previous treatments have delivered temporary improvement but not lasting change.</p>
                <p className="text-base-content/80 text-lg leading-relaxed mt-4">ULANDA's consultation-led model begins with understanding how the skin behaves before deciding how it should be treated. This differs from many aesthetic clinics serving the Harlow area where treatment selection often precedes clinical assessment.</p>
              </FadeInWhenVisible>
              <FadeInWhenVisible delay={0.2}>
                <p className="text-base-content/80 text-lg font-medium mt-6 mb-3">Clients visiting from Harlow often value:</p>
                <ul className="space-y-3">
                  {[
                    ...
                    'A calm clinical environment with free on-site parking and a short journey from Harlow',
                  ].map((item, idx) => (
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-3">Skin Concerns Commonly Assessed for Clients from Harlow</h2>
                <p className="text-xl font-light text-primary mb-6">The Presentations Most Commonly Seen at ULANDA</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Clients travelling from Harlow visit ULANDA for support with a range of skin concerns. Each links to the relevant authority page within the ULANDA ecosystem for the full clinical picture.</p>
              </FadeInWhenVisible>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-4">Treatments Available Near Harlow</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-3">The Full Range of Medical Aesthetic Treatments — Around 15 Minutes From Harlow</p>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">Many visitors searching for a skin clinic near Harlow already know the treatment they are interested in. The treatments below are available at ULANDA in Ware and are introduced following the Advanced Skin Health Consultation to ensure they are clinically appropriate and correctly sequenced within your treatment programme.</p>
              </FadeInWhenVisible>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <FadeInWhenVisible delay={0.1}>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting from Harlow begin with the Advanced Skin Health Consultation — the clinical assessment that establishes what your skin actually needs before any treatment is recommended.</p>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Skin Barrier Renewal Protocol treatment',
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-base-content/80 text-lg leading-relaxed"><span className="w-2 h-2 rounded-full bg-primary mt-2.5" />{item}</li>
                  ))}
                </ul>
        ...
        <section className="py-12 md:py-16 bg-base-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-6">Travelling from Harlow</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-8">ULANDA is approximately 15 minutes from Harlow via the A414, connecting Old Harlow and the surrounding neighbourhoods to Ware.</p>
              </FadeInWhenVisible>
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <FadeInWhenVisible delay={0.1}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    ...
                    <p className="text-base-content/80 leading-relaxed">ULANDA has dedicated free client parking directly at the clinic, making visits convenient for clients travelling from Harlow and surrounding areas.</p>
                  </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible delay={0.2}>
                  <div className="bg-secondary/30 rounded-xl p-6 border border-primary/10">
                    <h3 className="text-lg font-serif text-base-content mb-3">By Train</h3>
                    <p className="text-base-content/80 leading-relaxed">Harlow Town station connects to Ware via the Hertford East rail line, with a short change at Broxbourne.</p>
                  </div>
                </FadeInWhenVisible>
              </div>
              ...
              <FadeInWhenVisible delay={0.4}>
                <p className="text-base-content/80 text-lg leading-relaxed mt-6">ULANDA also welcomes clients from Sawbridgeworth, Bishop's Stortford, Hertford, Hoddesdon and Broxbourne.</p>
              </FadeInWhenVisible>
            </div>
          </div>
        </section>
        ...
        <section className="bg-secondary/20 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <FadeInWhenVisible>
                <h2 className="text-3xl font-serif text-base-content mb-5">Serving Harlow and East Hertfordshire</h2>
                <p className="text-base-content/80 text-lg leading-relaxed mb-4">Clients visiting ULANDA from Harlow often travel from surrounding areas including Old Harlow, Church Langley, Newhall and Sawbridgeworth.</p>
