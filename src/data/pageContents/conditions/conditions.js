...
export const conditions = [
  {
    ...
    hero: {
      ...
      description: [
        "Ageing is not simply “lines and wrinkles.”",
    ...
    science_removed: {
      ...
      items: [
        {
          number: '01',
          title: 'Collagen & Elastin Breakdown',
          description: 'By menopause, women lose up to 30% of collagen in the first 5 years.',
        },
        {
          number: '02',
          title: 'Slower Cell Turnover',
          description: 'Dead skin builds up → dullness, roughness, uneven tone.',
        },
        {
          number: '03',
          title: 'Volume Loss & Structural Changes',
          description: 'Fat pads shift, ligaments loosen → jowls, hollows, sagging.',
        },
        {
          number: '04',
          title: 'Hormonal Decline',
          description: 'Lower estrogen → dryness, thinning, crepiness.',
        },
        {
          number: '05',
          title: 'Mitochondrial Slowdown',
          description: 'Cells produce less energy → slower repair & more inflammation.',
        },
        {
          number: '06',
          title: 'Barrier Damage',
          subtitle: 'Roughness',
          description: 'Reduced ceramides → sensitivity, irritation, dehydration.',
        },
      ],
      footer: "Ageing is not just surface-level.This is why ULANDA works on the cellular, dermal, structural and internal layers together."
    },
    subConditions: {
      titlePrefix: "",
      highlight: "Age Related",
      titleSuffix: "Conditions We Treat",
      items: [
        {
          title: "Fine Lines &",
          highlight: "Wrinkles",
  ...
  },
  {
    ...
    subConditions: {
      ...
      highlight: "Body Skin & Structural",
      titleSuffix: "Concerns",
      items: [
        {
          title: "Body Skin",
          highlight: "Laxity",
  ...
  },
  {
    ...
    hero: {
      title: "Under-Eye &",
      highlight: "Periorbital Conditions",
      subtitle: "Ware • Hertford • SG12 • Hertfordshire",
      description: [
    ...
    subConditions: {
      titlePrefix: "Conditions We Treat",
      highlight: "Under the Eye Area",
      titleSuffix: "",
      items: [
        {
          title: "Dark",
  ...
  },
  {
    ...
    hero: {
      title: "Menopause &",
      highlight: "Hormone-Linked Skin Changes",
      subtitle: "Ware • Hertford • SG12 • Hertfordshire",
      description: [
    ...
    subConditions: {
      titlePrefix: "Conditions We Treat Under",
      highlight: "Menopause & Hormone-Linked Skin Changes",
      titleSuffix: "",
      items: [
        {
          title: "",
  ...
  },
  {
    ...
    subConditions: {
      titlePrefix: "Conditions We Treat Under",
      highlight: "Pigmentation & Skin Tone",
      titleSuffix: "",
      items: [
        {
          title: "Hyperpigmentation",
          highlight: "(Sun Damage / Age Spots)",
  ...
  },
  {
    ...
    subConditions: {
      titlePrefix: "Conditions We Treat Under",
      highlight: "Internal Wellness",
      titleSuffix: "",
      items: [
        {
          title: "Fatigue &",
          highlight: "Low Energy",
          ...
          placeholderUrl: "https://images.unsplash.com/photo-1561539207-46fec82a333c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8RmF0aWd1ZSUyMCUyNiUyMExvdyUyMEVuZXJneXxlbnwwfDF8MHx8fDA%3D",
          link: '/conditions/internal-wellness/fatigue-low-energy'
        },
        {
          title: "Low Immunity /",
          highlight: "Frequent Illness",
          ...
          placeholderUrl: "https://www.drtatiana.co.uk/wp-content/smush-webp/2019/03/low-immunity-548x794.jpg.webp",
          link: '/conditions/internal-wellness/low-immunity'
        },
        {
          title: "Slow Metabolism /",
          highlight: "Weight Gain",
          description: "Metabolic slowdown can occur long before visible changes. Common in perimenopause and postpartum. Metabolic imbalance worsens cellulite, texture, and body contour. ULANDA offers Medical Weight Management, NAD+ IV, Women’s Longevity IV, B12 IM to restore metabolic balance.",
          text: "Best solutions: Medical Weight Management, NAD+ IV, Women’s Longevity IV, B12 IM.",
          ...
          link: '/conditions/internal-wellness/slow-metabolism'
        },
        {
          ...
          placeholderUrl: "https://plus.unsplash.com/premium_photo-1728915175711-c7bf6c398396?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          link: '/conditions/internal-wellness/stress-inflammation'
        },
        {
          title: "Nutrient Deficiency-Linked",
          highlight: "Skin Issues",
          description: "Skin cannot glow if it doesn’t have the resources to repair. Vitamin D, B12, antioxidants and amino acids are essential for skin integrity. ULANDA’s Vitamin D IM, B12 IM, Glutathione IV, Beauty Glow IV restore the building blocks of youthful skin.",
          text: "Best solutions: Vitamin D IM, B12 IM, Glutathione IV, Beauty Glow IV.",
          ...
          link: '/conditions/internal-wellness/nutrient-deficiency-skin'
        }
      ]
    },
    pathways: {
